...
__export(index_exports, {
  ...
  monthDay: () => monthDay,
  number: () => number,
  schemaCacheClient: () => schemaCacheClient,
  schemaClientConfig: () => schemaClientConfig,
  schemaCourseCountriesResponse: () => schemaCourseCountriesResponse,
  schemaCourseCountry: () => schemaCourseCountry,
  schemaCourseCountryCode: () => schemaCourseCountryCode,
  schemaCourseDetailsRequest: () => schemaCourseDetailsRequest,
  schemaCourseDetailsResponse: () => schemaCourseDetailsResponse,
  schemaCourseHandicapEntry: () => schemaCourseHandicapEntry,
  schemaCourseHandicapGetRequest: () => schemaCourseHandicapGetRequest,
  schemaCourseHandicapsGetResponse: () => schemaCourseHandicapsGetResponse,
  schemaCourseHandicapsRequest: () => schemaCourseHandicapsRequest,
  schemaCoursePercentPlayerHandicap: () => schemaCoursePercentPlayerHandicap,
  schemaCoursePlayerHandicapsResponse: () => schemaCoursePlayerHandicapsResponse,
  schemaCourseSearchRequest: () => schemaCourseSearchRequest,
  schemaCourseSearchResponse: () => schemaCourseSearchResponse,
  schemaFacility: () => schemaFacility,
  schemaFacilityCourse: () => schemaFacilityCourse,
  schemaFacilitySearchRequest: () => schemaFacilitySearchRequest,
  schemaFacilitySearchResponse: () => schemaFacilitySearchResponse,
  schemaGolfer: () => schemaGolfer,
  schemaGolferCourseHandicapRequest: () => schemaGolferCourseHandicapRequest,
  schemaGolferHandicapResponse: () => schemaGolferHandicapResponse,
  schemaGolfersGlobalSearchRequest: () => schemaGolfersGlobalSearchRequest,
  schemaGolfersSearchRequest: () => schemaGolfersSearchRequest,
  schemaGolfersSearchResponse: () => schemaGolfersSearchResponse,
  schemaGpaAccessStatus: () => schemaGpaAccessStatus,
  schemaGpaAccessesResponse: () => schemaGpaAccessesResponse,
  schemaGpaRequestAccessResponse: () => schemaGpaRequestAccessResponse,
  schemaGpaRevokeAccessResponse: () => schemaGpaRevokeAccessResponse,
  schemaGpaUpdateStatusRequest: () => schemaGpaUpdateStatusRequest,
  schemaGpaUpdateStatusResponse: () => schemaGpaUpdateStatusResponse,
  schemaHoleDetail: () => schemaHoleDetail,
  schemaPlayerCourseHandicap: () => schemaPlayerCourseHandicap,
  schemaPlayingHandicapEntry: () => schemaPlayingHandicapEntry,
  schemaPlayingHandicapRequest: () => schemaPlayingHandicapRequest,
  schemaPlayingHandicapsResponse: () => schemaPlayingHandicapsResponse,
  schemaScorePost18h9and9Request: () => schemaScorePost18h9and9Request,
  schemaScorePostAdjustedRequest: () => schemaScorePostAdjustedRequest,
  schemaScorePostHbhRequest: () => schemaScorePostHbhRequest,
  schemaScorePostHoleDetail: () => schemaScorePostHoleDetail,
  schemaScorePostResponse: () => schemaScorePostResponse,
  schemaScoresRequest: () => schemaScoresRequest,
  schemaScoresResponse: () => schemaScoresResponse,
  schemaScoringAdjustment: () => schemaScoringAdjustment,
  schemaStatistics: () => schemaStatistics,
  schemaTeeSetRatingForScorePostingEntry: () => schemaTeeSetRatingForScorePostingEntry,
  schemaTeeSetRatingForScorePostingRequest: () => schemaTeeSetRatingForScorePostingRequest,
  schemaTeeSetRatingRequest: () => schemaTeeSetRatingRequest,
  schemaTeeSetRatingResponse: () => schemaTeeSetRatingResponse,
  schemaTeeSetRatingsForScorePostingResponse: () => schemaTeeSetRatingsForScorePostingResponse,
  schemaTeeSetSide: () => schemaTeeSetSide,
  shortDate: () => shortDate,
  string: () => string,
...
var schemaStringOrUndefined = import_zod.z.union([import_zod.z.string(), import_zod.z.undefined()]);
var schemaPromiseOrNonPromiseStringOrUndefined = import_zod.z.union([
  import_zod.z.promise(schemaStringOrUndefined),
  schemaStringOrUndefined
]);
var schemaPromiseOrNonPromiseVoid = import_zod.z.union([import_zod.z.promise(import_zod.z.void()), import_zod.z.void()]);
var schemaCacheClient = import_zod.z.object({
  read: import_zod.z.function().args().returns(schemaPromiseOrNonPromiseStringOrUndefined),
  write: import_zod.z.function().args(import_zod.z.string()).returns(schemaPromiseOrNonPromiseVoid)
});
...
var boolean = import_zod2.z.union([import_zod2.z.boolean(), import_zod2.z.literal("true"), import_zod2.z.literal("false"), import_zod2.z.null()]).transform((value) => value === true || value === "true");
var date = import_zod2.z.union([import_zod2.z.date(), import_zod2.z.string(), import_zod2.z.null(), import_zod2.z.undefined()]).refine(
  (value) => {
    if (value === null || value === void 0 || value === "") {
      return true;
    }
    if (value instanceof Date) {
      return (0, import_date_fns.isValid)(value);
    }
    if (typeof value === "string") {
      let parsed = (0, import_date_fns.parseISO)(value);
      if ((0, import_date_fns.isValid)(parsed)) {
        return true;
      }
      const formats = [
        "yyyy-MM-dd",
      ...
      return formats.some((format) => {
        try {
          parsed = (0, import_date_fns.parse)(value, format, /* @__PURE__ */ new Date());
          return (0, import_date_fns.isValid)(parsed);
        } catch {
          return false;
        }
      });
...
var emptyString = import_zod2.z.string().trim();
var emptyStringToNull = emptyString.nullable().transform((value) => value || null);
var float = import_zod2.z.coerce.number();
var gender = import_zod2.z.enum(["M", "F"]);
var handicap = import_zod2.z.union([float, import_zod2.z.string(), import_zod2.z.null()]).refine((value) => {
...
var teeSetSide = import_zod2.z.enum(["All18", "F9", "B9"]);
...
var shortDate = import_zod2.z.union([import_zod2.z.date(), import_zod2.z.string(), import_zod2.z.null()]).refine((value) => value ? !Number.isNaN(Date.parse(value.toString())) : true, {
  message: "Invalid date"
}).transform((value) => {
  if (typeof value !== "string") {
    return value;
...
// src/models/client-config.ts
var schemaClientConfig = import_zod3.z.object({
...
async function withRetry(operation, config = {}) {
  ...
  return (0, import_neverthrow.err)(new Error("Retry exhausted"));
}

// src/client/request-client/models/access-token.ts
var import_zod4 = require("zod");
var schemaAccessToken = import_zod4.z.object({
  expiresIn: string,
  token: string
...
var schemaSession = import_zod5.z.object({
  appId: string,
  authVersion: string,
  fid: string,
  sdkVersion: string
});
var schemaSessionResponse = import_zod5.z.object({
  authToken: schemaAccessToken
});

// src/client/request-client/models/login.ts
var import_zod6 = require("zod");
var schemaLoginAPIRequest = import_zod6.z.object({
...
var schemaLoginResponse = import_zod6.z.object({
  golfer_user: import_zod6.z.object({
    golfer_user_token: string
  })
});
var schemaLoginAPIResponse = import_zod6.z.object({
  user: import_zod6.z.object({
    id: string,
...
var RequestClient = class {
  ...
  constructor(config) {
    ...
    this.lock = new import_async_mutex.Mutex();
  ...
  async _fetch({
    ...
    try {
      ...
      return (0, import_neverthrow2.ok)(parsed.data);
    } catch (error) {
      if (error instanceof Error) {
        return (0, import_neverthrow2.err)(new NetworkError(`Network request failed: ${error.message}`, void 0, error));
      }
      return (0, import_neverthrow2.err)(new NetworkError(`Unknown network error: ${String(error)}`));
    }
  }
  ...
  async getAccessToken() {
    ...
    if (isAccessTokenValid) {
      return (0, import_neverthrow2.ok)(this.accessToken);
    }
    try {
      ...
      if (isCachedTokenValid) {
        ...
        return (0, import_neverthrow2.ok)(cachedAccessToken);
      }
    } catch (error) {
      return (0, import_neverthrow2.err)(
        new CacheError(
    ...
    return (0, import_neverthrow2.ok)(accessToken);
  }
  async apiLogin() {
    ...
    return response.andThen((resp) => {
      if (resp && "token" in resp) {
        return (0, import_neverthrow2.ok)(resp.token);
      }
      return (0, import_neverthrow2.err)(new Error("Login response did not contain a token."));
    });
  }
  async refreshAccessToken() {
    ...
    if (sessionResult.isErr()) {
      return (0, import_neverthrow2.err)(sessionResult.error);
    }
  ...
  async fetch({
    ...
    if (accessTokenResult.isErr()) {
      return (0, import_neverthrow2.err)(accessTokenResult.error);
    }
...
var schemaCourseCountryState = import_zod7.z.object({
  code: string,
...
var schemaCourseCountry = import_zod7.z.object({
  code: string,
  crs_code: import_zod7.z.string().trim().transform((value) => value || null).nullable(),
  name: string,
  states: import_zod7.z.array(schemaCourseCountryState)
});
...
// src/client/ghin/models/course/request.ts
var schemaCourseSearchRequest = import_zod8.z.object({
...
var schemaTeeSetStatus = import_zod8.z.enum(["Active", "Deleted", "All"]);
var schemaCourseDetailsRequest = import_zod8.z.object({
  course_id: number,
  gender: import_zod8.z.enum(["M", "m", "F", "f"]).optional(),
  number_of_holes: import_zod8.z.union([import_zod8.z.literal(9), import_zod8.z.literal(18)]).optional(),
...
var schemaGeoCoordinate = import_zod9.z.preprocess((value) => {
  ...
  return null;
}, import_zod9.z.number().nullable());
var schemaGeoAddress = import_zod9.z.preprocess((value) => {
  if (value === void 0 || value === null || value === "") {
    return null;
  }
  return value;
}, import_zod9.z.string().nullable());

// src/client/ghin/models/course/course.ts
var schemaStatus = string.transform((value) => value.toUpperCase()).pipe(import_zod10.z.enum(["ACTIVE", "INACTIVE"]));
var schemaCourse = import_zod10.z.object({
  ...
  Ratings: import_zod10.z.array(import_zod10.z.unknown()),
  State: string.nullable(),
  Telephone: string.nullable(),
  UpdatedOn: shortDate.nullable(),
  Zip: import_zod10.z.string().trim().transform((zip) => zip?.trim() || null).nullable().or(import_zod10.z.array(import_zod10.z.unknown()))
});

// src/client/ghin/models/course/season.ts
var import_zod11 = require("zod");
var schemaSeasonDate = import_zod11.z.preprocess((value) => {
  if (value === void 0 || value === null || value === "") {
    return null;
  }
  return value;
}, import_zod11.z.string().nullable());
var schemaSeasonName = import_zod11.z.preprocess((value) => {
  if (value === void 0 || value === null || value === "") {
    return null;
  }
  return value;
...
// src/client/ghin/models/course/response.ts
var schemaStatus2 = string.transform((value) => value.toUpperCase()).pipe(import_zod12.z.enum(["ACTIVE", "INACTIVE"]));
var schemaCourseCountriesResponse = import_zod12.z.object({
  countries: import_zod12.z.array(schemaCourseCountry.passthrough())
});
var schemaCourseSearchResponse = import_zod12.z.object({
  courses: import_zod12.z.array(schemaCourse.passthrough())
});
var schemaCourseDetailsFacility = import_zod12.z.object({
  FacilityId: number,
  FacilityName: string,
...
var schemaCourseDetailsSeason = import_zod12.z.object({
  IsAllYear: boolean,
...
var schemaCourseDetailsTeeSetRatings = import_zod12.z.object({
  BogeyRating: float,
  CourseRating: float,
  RatingType: import_zod12.z.enum(["Front", "Back", "Total"]),
  SlopeRating: float
});
var schemaCourseDetailsTeeSetHole = import_zod12.z.object({
  Allocation: number,
  HoleId: number,
  Length: number,
  Number: number,
...
var schemaCourseDetailsTeeSet = import_zod12.z.object({
  EligibleSides: import_zod12.z.unknown(),
  Gender: import_zod12.z.enum(["Male", "Female", "Mixed"]).nullable(),
  Holes: import_zod12.z.array(schemaCourseDetailsTeeSetHole),
  HolesNumber: number,
  IsShorter: boolean.nullable(),
  LegacyCRPTeeId: number,
  Ratings: import_zod12.z.array(schemaCourseDetailsTeeSetRatings),
...
var schemaCourseDetailsResponse = import_zod12.z.object({
  CourseCity: string,
  CourseId: number,
  CourseName: string,
  ...
  TeeSets: import_zod12.z.array(schemaCourseDetailsTeeSet)
});

// src/client/ghin/models/course/tee-set-rating.ts
var import_zod13 = require("zod");
var schemaStatus3 = string.transform((value) => value.toUpperCase()).pipe(import_zod13.z.enum(["ACTIVE", "INACTIVE"]));
var schemaTeeSetRatingRequest = import_zod13.z.object({
  tee_set_rating_id: number,
  include_altered_tees: boolean.optional().default(true)
});
var schemaTeeSetRatingSeason = import_zod13.z.object({
  SeasonName: schemaSeasonName,
  SeasonStartDate: schemaSeasonDate.transform((value) => {
    if (!value) {
      return null;
...
var schemaTeeSetRatingCourse = import_zod13.z.object({
  CourseId: number,
...
var schemaTeeSetRatingFacility = import_zod13.z.object({
  FacilityId: number,
  FacilityStatus: string,
  FacilityName: string,
  FacilityNumber: number.nullable(),
...
var schemaTeeSetRatingHole = import_zod13.z.object({
  HoleId: number,
  Number: number,
  Par: number,
  Length: number,
...
var schemaTeeSetRatingRating = import_zod13.z.object({
  RatingType: import_zod13.z.enum(["Front", "Back", "Total"]),
  CourseRating: float,
  SlopeRating: float,
  BogeyRating: float
});
var schemaTeeSetRatingResponse = import_zod13.z.object({
  Season: schemaTeeSetRatingSeason.nullable(),
  Course: schemaTeeSetRatingCourse,
  Facility: schemaTeeSetRatingFacility,
  TeeSetRatingId: number,
  TeeSetRatingName: string,
  TeeSetStatus: import_zod13.z.enum(["Active", "Inactive", "Deleted"]).transform((val) => val.toLowerCase()).optional(),
  Gender: import_zod13.z.enum(["Male", "Female", "Mixed"]).nullable(),
  HolesNumber: number,
  TotalPar: number,
  TotalYardage: number,
  TotalMeters: number,
  ...
  EligibleSides: import_zod13.z.unknown(),
  Holes: import_zod13.z.array(schemaTeeSetRatingHole),
  Ratings: import_zod13.z.array(schemaTeeSetRatingRating)
});

// src/client/ghin/models/course/tee-set-rating-for-score-posting.ts
var import_zod14 = require("zod");
var schemaTeeSetRatingForScorePostingRequest = import_zod14.z.object({
  course_id: number.positive()
});
var schemaTeeSetRatingForScorePostingEntry = import_zod14.z.object({
  tee_set_id: number,
  tee_name: string,
  gender: string,
  course_rating: float,
...
var schemaTeeSetRatingsForScorePostingResponse = import_zod14.z.object({
  tee_set_ratings: import_zod14.z.array(schemaTeeSetRatingForScorePostingEntry)
}).passthrough();

// src/client/ghin/models/facility/facility.ts
var import_zod15 = require("zod");
var schemaStatus4 = string.transform((value) => value.toUpperCase()).pipe(import_zod15.z.enum(["ACTIVE", "INACTIVE"]));
var schemaFacilityCourse = import_zod15.z.object({
  CourseId: number,
  CourseStatus: schemaStatus4,
  CourseName: string,
  NumberOfHoles: number
});
var schemaFacility = import_zod15.z.object({
  Address1: string.nullable().optional(),
  Address2: string.nullable().optional(),
  Associations: import_zod15.z.array(import_zod15.z.unknown()).optional(),
  City: string.nullable(),
  Country: string.nullable(),
  Courses: import_zod15.z.array(schemaFacilityCourse).optional(),
  ...
  Zip: import_zod15.z.string().trim().transform((zip) => zip?.trim() || null).nullable().optional().or(import_zod15.z.array(import_zod15.z.unknown()))
});

// src/client/ghin/models/facility/request.ts
var import_zod16 = require("zod");
var schemaFacilitySearchRequest = import_zod16.z.object({
  country: schemaCourseCountryCode.optional(),
  facility_id: number.optional(),
  name: string.optional(),
  state: schemaCourseSearchState.optional()
...
var schemaFacilitySearchResponse = import_zod17.z.array(schemaFacility);

// src/client/ghin/models/golfers/search.ts
var import_zod18 = require("zod");
var schemaStatus5 = import_zod18.z.enum(["Active", "Inactive"]);
var schemaGolfersGlobalSearchRequest = import_zod18.z.object({
  country: string.transform((value) => value?.toUpperCase()),
  first_name: string,
  from_ghin: boolean,
  ghin: number,
  last_name: string.optional(),
  order: import_zod18.z.enum(["asc", "desc"]),
  page: number,
  per_page: number.max(100),
  sorting_criteria: import_zod18.z.enum(["country", "full_name", "handicap_index", "state", "status"]),
  state: string.transform((value) => value?.toUpperCase()),
  status: schemaStatus5
}).partial();
var schemaGolfersSearchRequest = import_zod18.z.object({
  page: number,
  per_page: number.max(100),
  ...
  sorting_criteria: import_zod18.z.enum([
    "first_name",
    "last_name",
    "status",
    "id",
  ...
  order: import_zod18.z.enum(["asc", "desc"]).optional(),
  status: schemaStatus5.optional(),
  updated_since: emptyStringToNull.optional()
}).partial();
var schemaGolfer = import_zod18.z.object({
  ghin: number,
  first_name: string,
  last_name: string,
...
var schemaGolfersSearchResponse = import_zod18.z.object({
  golfers: import_zod18.z.array(schemaGolfer)
});

// src/client/ghin/models/gpa/access.ts
var import_zod19 = require("zod");
var schemaGpaAccessStatus = import_zod19.z.object({
  golfer_id: number,
  status: string
}).passthrough();
var schemaGpaAccessesResponse = import_zod19.z.object({
  gpa_accesses: import_zod19.z.array(schemaGpaAccessStatus)
});
var schemaGpaRequestAccessResponse = import_zod19.z.object({
  golfer_id: number,
  status: string
}).passthrough();
var schemaGpaUpdateStatusRequest = import_zod19.z.object({
  user_id: number,
  golfer_id: number,
  status: import_zod19.z.enum(["approved", "denied"])
});
var schemaGpaUpdateStatusResponse = import_zod19.z.object({
  golfer_id: number,
  status: string
}).passthrough();
var schemaGpaRevokeAccessResponse = import_zod19.z.object({
  golfer_id: number
}).passthrough();

// src/client/ghin/models/handicaps/course-handicap.ts
var import_zod20 = require("zod");
var schemaCourseHandicapGetRequest = import_zod20.z.object({
  golfer_id: number,
  course_id: number,
  tee_set_id: number,
  tee_set_side: teeSetSide,
...
var schemaCourseHandicapEntry = import_zod20.z.object({
  golfer_id: number,
  course_handicap: float,
  handicap_index: float.nullable().optional()
}).passthrough();
var schemaCourseHandicapsGetResponse = import_zod20.z.object({
  course_handicaps: import_zod20.z.array(schemaCourseHandicapEntry)
});

// src/client/ghin/models/handicaps/course-player-handicap.ts
var import_zod21 = require("zod");
var schemaPlayerCourseHandicap = import_zod21.z.object({
  playing_handicap: number,
  playing_handicap_display: string,
  shots_off: number
});
var schemaCoursePercentPlayerHandicap = import_zod21.z.record(string, schemaPlayerCourseHandicap);

// src/client/ghin/models/handicaps/playing-handicap.ts
var import_zod22 = require("zod");
var schemaPlayingHandicapRequest = import_zod22.z.object({
  golfer_id: number,
  course_id: number,
  tee_set_id: number,
  tee_set_side: teeSetSide,
...
var schemaPlayingHandicapEntry = import_zod22.z.object({
  golfer_id: number,
  playing_handicap: number,
  course_handicap: float,
  handicap_index: float.nullable().optional()
}).passthrough();
var schemaPlayingHandicapsResponse = import_zod22.z.object({
  playing_handicaps: import_zod22.z.array(schemaPlayingHandicapEntry)
});

// src/client/ghin/models/handicaps/request.ts
var import_zod23 = require("zod");
var schemaTeeSetSide = import_zod23.z.enum(["All 18", "F9", "B9"]);
var schemaGolferCourseHandicapBaseRequest = import_zod23.z.object({
...
var schemaCourseHandicapsRequest = import_zod23.z.object({
  golfers: import_zod23.z.array(
  ...
  source: import_zod23.z.literal(CLIENT_SOURCE).default(CLIENT_SOURCE).optional()
});

// src/client/ghin/models/handicaps/response.ts
var import_zod24 = require("zod");
var schemaGolferHandicapClub = import_zod24.z.object({
  active: boolean,
  association_id: number,
  club_name: string,
  id: number
});
var schemaGolferHandicapResponse = import_zod24.z.object({
  golfer: import_zod24.z.object({
    clubs: import_zod24.z.array(schemaGolferHandicapClub),
    handicap_index: handicap
  })
}).passthrough();
var schemaCoursePlayerHandicapsResponse = import_zod24.z.object({
...
var schemaScoringAdjustment = import_zod25.z.object({
  display: string,
  type: string,
  value: float
});
...
var schemaScorePostHoleDetail = import_zod27.z.object({
  hole_number: number.min(1).max(18),
  raw_score: number.min(1),
  x_hole: boolean.optional()
});
var schemaScoreType = import_zod27.z.enum(["H", "A", "T"]);
var schemaNumberOfHoles = import_zod27.z.enum(["9", "18"]);
var schemaScorePostHbhRequest = import_zod27.z.object({
  golfer_id: string,
  course_id: string,
  tee_set_id: string,
  tee_set_side: teeSetSide,
  ...
  hole_details: import_zod27.z.array(schemaScorePostHoleDetail).min(1),
...
var schemaScorePostAdjustedRequest = import_zod27.z.object({
  golfer_id: string,
  course_id: string,
  tee_set_id: string,
  tee_set_side: teeSetSide,
...
var schemaScorePost18h9and9Request = import_zod27.z.object({
  golfer_id: string,
  course_id: string,
  tee_set_id: string,
  played_at: string,
  ...
  number_of_holes: import_zod27.z.literal("18"),
  gender,
  override_confirmation: boolean.optional(),
  is_manual: boolean.optional()
});
...
var schemaScorePostResponseInner = import_zod28.z.object({
  id: number,
  golfer_id: number,
  status: import_zod28.z.enum(["Validated", "UnderReview"]),
...
var schemaScorePostResponse = import_zod28.z.object({
...
var schemaStatistics = import_zod29.z.object({
...
var schemaRawScoreTypes = import_zod30.z.enum(rawScoreTypes);
var scoreTypes = ["AWAY", "COMBINED", "EXCEPTIONAL", "HOME", "9_HOLE_ROUNDS", "PENALTY", "TOURNAMENT"];
var schemaScoreType2 = import_zod30.z.enum(scoreTypes);
var scoreTypesMap = {
  A: "AWAY",
  C: "COMBINED",
  E: "EXCEPTIONAL",
...
var schemaScoreStatus = import_zod30.z.enum(scoreStatuses);
var rawScoreStatuses = ["Validated", "UnderReview"];
var schemaRawScoreStatus = import_zod30.z.enum(rawScoreStatuses);
...
var schemaScore = import_zod30.z.object({
  adjusted_gross_score: number,
  adjustments: import_zod30.z.array(schemaScoringAdjustment),
  ...
  gender,
  golfer_id: number,
  hole_details: import_zod30.z.array(schemaHoleDetail),
  id: number,
  is_manual: boolean,
  is_recent: boolean,
  message_club_authorized: string.nullable(),
...
// src/client/ghin/models/scores/request.ts
var schemaScoresRequest = import_zod31.z.object({
  course_id: number,
  from_date_played: date,
  limit: number.default(100),
  offset: number.default(0),
  score_types: import_zod31.z.array(import_zod31.z.enum(rawScoreTypes)),
  statuses: import_zod31.z.array(string),
  tee_set_id: number,
  to_date_played: date
...
var schemaNumberOrDash = import_zod32.z.union([number, import_zod32.z.literal("-")]).transform((value) => value === "-" ? null : Number(value));
var schemaFloatOrDash = import_zod32.z.union([float, import_zod32.z.literal("-")]).transform((value) => value === "-" ? null : Number.parseFloat(value.toString()));
var schemaScoresResponse = import_zod32.z.object({
  average: schemaFloatOrDash.default(0),
  highest_score: schemaNumberOrDash,
  lowest_score: schemaNumberOrDash,
  scores: import_zod32.z.array(schemaScore),
...
var GhinClient = class {
  ...
  async handicapsGetCoursePlayerHandicaps(request) {
    try {
      const golfers = import_zod33.z.array(schemaGolferCourseHandicapRequest).parse(request).map(({ ghin, ...golfer }) => ({
        ...golfer,
